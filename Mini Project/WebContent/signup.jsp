...
<body>
	...
	Doctor Signup Form:
	<form action=createDoctor.jsp onsubmit="return validateSignupForm()" method=POST >
		User name: <input type=text id=dname name=dname><br>
		<div id=dname_req style="color: red; display: none;">*Username is required</div>
		...
		<div id=name_req style="color: red; display: none;">*Name is required</div>
